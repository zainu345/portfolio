  ...
  const tabContent = [
    {
      ...
      emoji: "🚀",
      title: "Background",
      content: "I'm a passionate Full Stack Developer with expertise in MERN, ReactJS, NodeJS, and TypeScript. A recent graduate from PUCIT, Lahore, I achieved a 4.0 CGPA in core programming subjects.",
    ...
    },
    {
      ...
      emoji: "💼",
      title: "Experience",
      content: "Currently, I'm an Associate Software Engineer (MERN Stack) at Kwanso, where I focus on ReactJS, NodeJS, and TypeScript. I gained practical experience during my summer internships at DevTown and Pyflow, enhancing my MERN Stack skills.",
